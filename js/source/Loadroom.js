...
for (var i = 0; i <= 19; i++) {
  for (var j = 0; j <= 19; j++) {
    wallVertexPositionBuffer[i][j] = { }
    wallVertexTextureCoordBuffer[i][j] = { }
    floorVertexPositionBuffer[i][j] = { }
    floorVertexTextureCoordBuffer[i][j] = { }
    ceilingVertexPositionBuffer[i][j] = { }
    ceilingVertexTextureCoordBuffer[i][j] = { }
  }
}
